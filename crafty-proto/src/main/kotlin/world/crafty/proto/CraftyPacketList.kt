...
fun registerVertxCraftyCodecs(eb: EventBus) {
    ...
    eb.registerDefaultCodec<AddEntityCraftyPacket>(AddEntityCraftyPacket.Codec)
    eb.registerDefaultCodec<RemoveEntityCraftyPacket>(RemoveEntityCraftyPacket.Codec)
}
